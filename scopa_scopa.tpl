...
<script type="text/javascript">
    ...
    var jstpl_player_board = '<div class="scp_deck" id="cp_deck_${player_id}">${card_count}</div><div class="scp_scopa_points scp_deck" id="scp_scopa_points_${player_id}">${scopa_in_round}</div><div class="scp_team" id="cp_team_${player_id}">${ally_name}</div>';
